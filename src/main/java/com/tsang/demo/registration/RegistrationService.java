...
import com.tsang.demo.appuser.AppUserRole;
import com.tsang.demo.appuser.AppUserService;
import com.tsang.demo.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest registrationRequest) {
        boolean isValidEmail = emailValidator.test(registrationRequest.getEmail()); // Kiểm tra email hợp lệ hay k
        if(!isValidEmail){
